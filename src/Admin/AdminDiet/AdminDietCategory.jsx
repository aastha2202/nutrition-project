    ...
    return (
      ...
      <span>Click count: {clickCount}</span> */}
            ...
            {categoryData?.map(item => {
                return (
                    <Card   {...longPressEvent}  style={{ backgroundColor: "#F0E7F5", margin: '1rem', boxShadow: '#c4c4c4', }}>
                        <CardContent>
                        {/* to="/dashboardadmin/adminproteins" component={RouterLink} */}
                            <Grid container spacing={2} to="/dashboardadmin/adminproteins" state={{ data: item}} component={RouterLink} sx={{ textDecoration: 'none' }} justifyContent='center' alignItems='center'>
