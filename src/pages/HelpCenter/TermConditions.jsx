  ...
  >
   ...
   <Typography variant="h3" align="center" sx={{ mt: 4, mb: 2 }}>
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "25px" ,fontFamily: 'Inter-SemiBold'}} >MODIFICATION OF THESE TERMS OF USE</Typography>

      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}}> This Practice reserves the right to change the terms, conditions, and notices under which this Practice website is offered, including but not limited to the charges associated with the use of this Practice website.
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "30px" ,fontFamily: 'Inter-SemiBold'}} >USE OF COMMUNICATION SERVICES</Typography>

      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}}> This Practice website may contain bulletin board services, chat areas, news groups, forums, communities, personal web pages, calendars, and/or other message or communication facilities designed to enable you to communicate with the public at large or with a group (collectively, "Communication Services"), you agree to use the Communication Services only to post, send and receive messages and material that are proper and related to the particular Communication Service.
...
By way of example, and not as a limitation, you agree that when using a Communication Service, you will not:</Typography>
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "30px" ,fontFamily: 'Inter-SemiBold'}} >COPYRIGHT AND TRADEMARK NOTICES</Typography>

      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}}> All contents of this website are Copyright © 2023 PatientPop Inc. All Rights Reserved. All logos are trademarks and service marks of PatientPop Inc. All other trademarks, service marks and logos used in this website are the property of their respective owners.
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "30px" ,fontFamily: 'Inter-SemiBold'}} >TRADEMARKS</Typography>

      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}}> The names of actual companies and products mentioned herein may be the trademarks of their respective owners.The example companies, organizations, products, people and events depicted herein are fictitious. No association with any real company, organization, product, person, or event is intended or should be inferred.Any rights not expressly granted herein are reserved.</Typography>
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "30px" ,fontFamily: 'Inter-SemiBold'}} >NOTICES</Typography>
