...
function AboutUs() {
  ...
  >
   ...
   <Typography variant="h3" align="center" sx={{ mt: 4, mb: 2 }}>
    ...
    <Container maxWidth="lg" sx={{margin:"10px"}}>

      <Grid >

      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}} >MODIFICATION OF THESE TERMS OF USE</Typography>

      <Typography style={{fontSize: "16px" ,fontFamily: 'Inter-SemiBold'}}> This Practice reserves the right to change the terms, conditions, and notices under which this Practice website is offered, including but not limited to the charges associated with the use of this Practice website.
    ...
    <Container maxWidth="lg" sx={{padding: theme.spacing(2),
      ...
      <Typography style={{fontSize: "20px" ,fontFamily: 'Inter-SemiBold'}} >USE OF COMMUNICATION SERVICES</Typography>

      <Typography style={{fontSize: "16px" ,fontFamily: 'Inter-SemiBold'}}> This Practice website may contain bulletin board services, chat areas, news groups, forums, communities, personal web pages, calendars, and/or other message or communication facilities designed to enable you to communicate with the public at large or with a group (collectively, "Communication Services"), you agree to use the Communication Services only to post, send and receive messages and material that are proper and related to the particular Communication Service.
